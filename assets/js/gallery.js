...
!(function (a) {
    var b = {
        init: function (b) {
            var c = { inDuration: 300, outDuration: 200, responsiveThreshold: 992, contentPadding: 40, onShow: null, defaultColor: "#444", fillScreen: !1, dynamicRouting: !1 };
            b = a.extend(c, b);
            ...
            return this.each(function (c) {
                function e() {
                    if (G) {
                        ...
                        d.off("click.galleryExpand").off("mouseenter.galleryExpand").off("mouseleave.galleryExpand"),
                            g.scrollTop(0),
                            g.attr("style", D.attr("style")),
                            L.css("left", D.find(".gallery-cover").css("left")).removeClass("dh ep"),
                            _(),
                            a("body").css("overflow", ""),
                            g.css("overflowY", ""),
                            d.css({ transition: "none", opacity: 0.9 }),
                            M.show(),
                            setTimeout(function () {
                                if (
                                    (a(window).off("resize", B),
                                        J.find(".gallery-body").css("display", "none"),
                                    P && P.find(U).removeClass("active"),
                                        a("nav").removeClass("ed"),
                                        a("#placeholder-navbar").fadeOut(b.outDuration, "easeInQuad", function () {
                                            a(this).remove();
                                        }),
                                        (H = !1),
                                        d.fadeOut(b.outDuration, "easeInQuad", function () {
                                            a(this).remove();
                                        }),
                                        !c)
                                ) {
                                    J.css({ width: h, height: i, transform: "translate3d(0,0,0)", transition: "transform " + b.outDuration / 1e3 + "s " + W, "-webkit-transition": "-webkit-transform " + b.outDuration / 1e3 + "s " + W });
                                    var e = p.top - T - V;
                                    N.css({ transform: "translate3d(0, " + e + "px, 0)", transition: "transform " + b.outDuration / 1e3 + "s", "-webkit-transition": "-webkit-transform " + b.outDuration / 1e3 + "s" });
                                    var f = {};
                                    S && Q
                                        ? ((f.width = n),
                                            (f.height = o),
                                            (f.transform = "translate3d(" + p.left + "px, " + V + "px, 0)"),
                                            (f.transition = "transform " + b.outDuration / 1e3 + "s, width " + b.outDuration / 1e3 + "s, height " + b.outDuration / 1e3 + "s"),
                                            (f["-webkit-transition"] = "-webkit-transform " + b.outDuration / 1e3 + "s, width " + b.outDuration / 1e3 + "s, height " + b.outDuration / 1e3 + "s"),
                                            $.css({ background: "" }))
                                        : ((f.transform = "translate3d(" + (p.left - A - V) + "px, 0, 0)"),
                                            (f.transition = "transform " + b.outDuration / 1e3 + "s " + W),
                                            (f["-webkit-transition"] = "-webkit-transform " + b.outDuration / 1e3 + "s " + W)),
                                        L.css(f),
                                        M.css({ transform: "translate3d(" + j.left + "px," + m + "px,0)", transition: "transform " + b.outDuration / 1e3 + "s", "-webkit-transition": "-webkit-transform " + b.outDuration / 1e3 + "s" });
                                }
                                C = setTimeout(function () {
                                    g.removeAttr("style"),
                                        J.css({ width: "", height: "", overflow: "", "z-index": "", transform: "", transition: "", "-webkit-transition": "" }),
                                        L.removeAttr("style").attr("style", E),
                                        N.removeAttr("style"),
                                        M.removeAttr("style"),
                                        M.children().removeAttr("style"),
                                        O.find(".title-wrapper").css({ marginTop: "", marginLeft: "", paddingLeft: "", height: "" }),
                                        J.removeClass("active"),
                                        (F = !0),
                                    a(".gallery").data("masonry") && a(".gallery").masonry("layout");
                                }, b.outDuration);
                            }, 0);
                    }
                }
                var f,
                    ...
                    Z = !1;
                (g = J.children(".placeholder").first()),
                g.length || (J.wrapInner(a('<div class="placeholder"></div>')), (g = J.children(".placeholder").first())),
                M.length || ((M = a('<div class="gallery-header invisible"></div>')), L.length ? L.after(M) : N.append(M));
                ...
                var _ = function () {
                    ...
                    aa = function () {
                        (origContainerRect = J[0].getBoundingClientRect()),
                            (h = origContainerRect.width),
                            (i = J.height()),
                            (j = M[0].getBoundingClientRect()),
                            (k = j.width),
                            (l = j.height || 1),
                            (n = L.width()),
                            (o = L.height()),
                            (p = L.length ? L[0].getBoundingClientRect() : { top: j.top, left: 0 }),
                ...
                J.off("click.galleryExpand").on("click.galleryExpand", function (c) {
                    ...
                    var d,
                        ...
                        da = function () {
                            ...
                            if (
                                ((Z = Z && ("visible" == c.overflow || "visible" == c.overflowY || "auto" == c.overflow || "auto" == c.overflowY)),
                                    (T = f ? 56 : 64),
                                    (t = -J[0].getBoundingClientRect().top),
                                    (u = void 0 === u ? -g[0].getBoundingClientRect().left : u + -g[0].getBoundingClientRect().left),
                                    (V = f ? 20 : b.contentPadding),
                                    (v = Math.round(o / 2 + V + T)),
                                    (d = o / 2 - V),
                                    (q = 0.7 * X),
                                    (_ = Y - d - T),
                                    (A = Math.max((X - q) / 2, V)),
                    ...
                    if (
                        (da(),
                            (D = g.clone(!0)),
                            a("body").css("overflowX", "hidden"),
                            a("body").on("scroll.disable-scroll mousewheel.disable-scroll touchmove.disable-scroll", function (a) {
                                return a.preventDefault(), a.stopPropagation(), !1;
                            }),
                            J.css({ height: i, width: h }),
                            L.length)
                    ) {
                        E = L.attr("style");
                        var ea = "translate3d(";
                        Q ? (ea += p.left + "px, " + V + "px, 0)") : (L.css({ left: A + V, top: V }), (ea += p.left - A - V + "px, 0, 0)")), L.css({ height: o, width: n, transform: ea });
                    }
                    var fa = p.top - T - V;
                    N.css({ display: "block", transform: "translate3d(0, " + fa + "px, 0)" }),
                        (m = R ? V - l : V),
                        M.css({ height: l, width: k, transform: "translate3d(" + j.left + "px," + m + "px,0)" }),
                        g.css({ height: Y, width: X, transform: "translate3d(" + Math.round(u) + "px, " + Math.round(t) + "px, 0)" }),
                        J.addClass("active"),
                    "absolute" !== J.css("position") && J.css({ position: "relative" }),
                        (H = !0),
                        (I = !1);
                    var ga = a("#placeholder-overlay");
                    ga.length || ((ga = a('<div id="placeholder-overlay"></div>')), g.prepend(ga)),
                        ga.off("click.galleryExpand").on("click.galleryExpand", function () {
                            e();
                        }),
                    Q &&
                    ga
                    ...
                    var ha = a('<nav id="placeholder-navbar"></nav>'),
                        ...
                        ja = a('<div class="container"></div>'),
                        ka = a('<button class="back-btn"><i class="material-icons">arrow_back</i><span>Back</span></button>'),
                        la = "";
                    if (
                        (a("nav").length && ((la = a("nav").css("background-color")), a("nav").addClass("ed")),
                            ha.css({ "background-color": la }),
                            ja.append(ka),
                            ia.append(ja),
                            ha.append(ia),
                            g.prepend(ha),
                            ...
                            (y = b.defaultColor),
                        "undefined" != typeof ColorThief && L.length)
                    ) {
                        w = new ColorThief();
                        var ma = new Image();
                        (ma.onload = function () {
                    ...
                    if (((qa.transform = ""), (qa.transition = "transform " + b.inDuration / 1e3 + "s"), (qa["-webkit-transition"] = "-webkit-transform " + b.inDuration / 1e3 + "s"), S))
                        if (Q) {
                            (qa.width = r),
                                (qa.height = s),
                                (qa.transition = "transform " + b.inDuration / 1e3 + "s, width " + b.inDuration / 1e3 + "s, height " + b.inDuration / 1e3 + "s"),
                                (qa["-webkit-transition"] = "-webkit-transform " + b.inDuration / 1e3 + "s, width " + b.inDuration / 1e3 + "s, height " + b.inDuration / 1e3 + "s");
                            r < X && (qa.transform = "scale(" + X / r + ")");
                        } else qa.transform = "scale(" + r / n + ")";
                    L.css(qa), N.css({ height: Y, transition: "transform " + b.inDuration / 1e3 + "s " + W, "-webkit-transition": "-webkit-transform " + b.inDuration / 1e3 + "s " + W, transform: "" }), M.children().css("opacity", 0);
                    var ra = function () {
                        var a = A / ba,
                            c = -d / ca;
                        S && !Q && (c = (d - o) / ca),
                    ...
                    ra(),
                    O.length &&
                    (O.css({ marginTop: v, padding: V, minHeight: Y - v }), !Q && L.length && (f ? O.find(".title-wrapper").css({ marginTop: v / 2 }) : O.find(".title-wrapper").css({ marginLeft: n, paddingLeft: V, height: d }))),
                    P.length &&
                    (P.css({ top: v }),
                        ...
                        (C = setTimeout(function () {
                            ...
                            var c = function () {
                                (D = g.clone(!0)),
                                    g.css({ transform: "", position: "fixed", width: "100%", height: "100%", top: 0, left: 0, overflow: "auto" }),
                                Z && (a("body").css("overflow", "hidden"), g.css("overflowY", "scroll")),
                                    a("body").off("scroll.disable-scroll mousewheel.disable-scroll touchmove.disable-scroll"),
                                    N.css({ height: "100%" }),
                                    Q ? L.css({ width: "", height: "", transform: "", transition: "opacity .3s" }) : L.css({ left: V }),
                                    L.addClass("dh"),
                                    M.hide();
                            };
                            O.length
                                ...
                                (I = !0),
                                (G = !0),
                            "function" == typeof b.onShow && b.onShow.call(this, J);
                        }, b.inDuration));
                }),
        ...
        a(function () {
            ...
            if (b.length) {
                ...
                c.each(function () {
                    var b = a(this);
                    b.on("click", function () {
                        c.removeClass("active"), b.addClass("active");
                        ...
                        d.masonry({ transitionDuration: ".3s" }),
            ...
            a(".t:not(.carousel-slider)").carousel({ dist: 0, padding: 10 }),
                a(".t.carousel-slider").carousel({
                    fullWidth: !0,
                    indicators: !0,
                    onCycleTo: function (b) {
                        a(".nav-background img").removeClass("active"), a(".nav-background img").eq(b.index()).addClass("active");
                    },
                });
            var d = a(".b");
            d.masonry({ itemSelector: ".ce", columnWidth: ".ce", transitionDuration: 0 }),
